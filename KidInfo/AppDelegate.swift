...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //        DropboxClientsManager.setupWithAppKey("t8f16412v21o79p");
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "KidInfo")
    ...
    // Check for access to contacts library
    func requestAccessForContacts(completionHandler: @escaping (_ accessGranted: Bool) -> Void){
